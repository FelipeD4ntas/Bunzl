...
public class NegociacaoComercialAdicionarAnexoValidator : AbstractValidator<NegociacaoComercialAdicionarAnexoRequest>
{
    public NegociacaoComercialAdicionarAnexoValidator()
    {
