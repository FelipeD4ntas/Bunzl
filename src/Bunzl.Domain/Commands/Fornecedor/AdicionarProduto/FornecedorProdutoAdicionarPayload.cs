...
public class FornecedorProdutoAdicionarPayload
{
	...
	public FornecedorProdutoAdicionarRequest ToRequest(Guid fornecedorId)
    {
        return new FornecedorProdutoAdicionarRequest(
            fornecedorId,
            CodigoFornecedor,
