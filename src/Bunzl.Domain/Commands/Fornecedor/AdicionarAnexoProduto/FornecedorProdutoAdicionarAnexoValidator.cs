...
public class FornecedorProdutoAdicionarAnexoValidator : AbstractValidator<FornecedorProdutoAdicionarAnexoRequest>
{
    public FornecedorProdutoAdicionarAnexoValidator()
    {
        ...
        RuleFor(p => p.TipoDocumento)
            .NotEmpty()
            .WithMessage(FornecedorResources.ProdutoTipoDocumentoObrigatorio);
    }
