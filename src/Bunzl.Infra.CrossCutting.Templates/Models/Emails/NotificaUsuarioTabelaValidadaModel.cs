...
public class NotificaUsuarioTabelaValidadaModel(string fornecedorNome, string usuarioNome, string empresaNome, string destinatario, string assunto, string titulo)
    : TemplateEmailModelBase(TipoTemplateEmailEnum.NotificaUsuarioTabelaValidada, destinatario, assunto, titulo)
{
