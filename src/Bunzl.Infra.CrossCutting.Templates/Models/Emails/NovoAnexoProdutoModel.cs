...
public class NovoAnexoProdutoModel(string nome, string nomeFornecedor, string produtoCodigo, string produtoDescricao, string destinatario, string assunto, string titulo)
    : TemplateEmailModelBase(TipoTemplateEmailEnum.NovoAnexoProduto, destinatario, assunto, titulo)
{
